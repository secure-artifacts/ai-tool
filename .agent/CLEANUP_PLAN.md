...
- [x] **提取内联样式到 CSS 工具类** (18 处静态样式)
  - 添加工具类: `flex-overflow-container`, `color-scheme-light`, `will-change-auto`
  - 添加工具类: `crop-handle-tl/tr/bl/br`, `w-32px`, `left-32px`, `z-max`
  - 添加工具类: `pointer-events-auto`, `cursor-pointer`, `pos-relative`
- [x] **清理 console.log** (110 处已注释)
  - index.tsx: 37 处
  - services/*.ts: 73 处
  - 保留 console.error (311) 和 console.warn (116)
...
| console.log | 110 | **0** | 0 | ✅ 完成 (已注释) |
| 内联样式 | 213 | **155** | <50 | 🔶 进行中 (动态样式保留) |
