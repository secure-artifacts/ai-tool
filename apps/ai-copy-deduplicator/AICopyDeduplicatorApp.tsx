...
export default function AICopyDeduplicatorApp({ getAiInstance, textModel = 'gemini-3-flash-preview' }: AICopyDeduplicatorAppProps) {
                                    ...
                                    return (
                                        <tr key={group.id} className={group.similarItems.length > 0 ? 'has-similar' : ''}>
                                            ...
                                            {Array.from({ length: Math.max(...state.result!.similarGroups.map(g => g.similarItems.length), 0) }).map((_, i) => {
                                                ...
                                                return (
                                                    <td key={i} className="col-similar">
                                                        {similarItem ? (
                                                            <div
                                                                className="similar-item tooltip-bottom"
                                            ...
                                            <td className="col-actions">
                                                <button
                                                    className="delete-btn tooltip-bottom"
