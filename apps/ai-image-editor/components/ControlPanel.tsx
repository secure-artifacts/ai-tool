...
import { PromptMode, ChatMessage } from '../App';
    ...
    <div className="flex items-center gap-2" style={{ pointerEvents: isLoading ? 'none' : 'auto' }}>
      <div className="flex items-center bg-[var(--color-bg)] p-0.5 rounded-lg border border-[var(--color-border)]">
        <button
          ...
          className={`p-1.5 rounded-md transition-colors ${promptMode === 'edit' ? 'bg-[var(--color-indigo)] text-white' : 'text-[var(--color-text-secondary)] hover:bg-[var(--color-bg-contrast)]'}`}
        >
        ...
        <button
          ...
          className={`p-1.5 rounded-md transition-colors ${promptMode === 'generate' ? 'bg-[var(--color-indigo)] text-white' : 'text-[var(--color-text-secondary)] hover:bg-[var(--color-bg-contrast)]'}`}
        >
    ...
    >
      <div className="max-w-6xl mx-auto">
        <div className="relative">
          ...
          {(promptMode === 'generate' || (promptMode === 'edit' && isPromptExpanded)) && (
            <div 
